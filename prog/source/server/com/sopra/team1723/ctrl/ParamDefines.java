...
/**
 * Diese Klasse enthält alle Parameter die übertragen werden sowie die
 * JSON-Objekte
 *
 */
public class ParamDefines
{
    ...
    // für das gewählte Semester und Studiengang
    ...
    // Allgemeiner Fehler. Die Übergebene Parameter sind unbekannt oder es
    // fehlen Parameter
    public final static String jsonErrorInvalidParam              = "invalidparam";
    // Der Benutzer ist nicht eingeloggt und hat deshalb nicht die benötigen
    // Rechte
