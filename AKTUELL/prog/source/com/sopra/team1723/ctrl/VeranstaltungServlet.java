...
public class VeranstaltungServlet extends ServletController
{
    ...
    private boolean veranstaltungErstellen(HttpServletRequest request, HttpServletResponse response) throws IOException
    {
        ...
        if (studiengaenge == null || studiengaenge.length == 0 || isEmptyAndRemoveSpaces(semester)
                || isEmptyAndRemoveSpaces(zugangspasswort) || isEmptyAndRemoveSpaces(titel)
    ...
    /**
     * Aus der Datenbank wird mit Hilfe der VeranstaltungsID die Informationen
     * bezuglich der Veranstaltung gelesen und zuruckgegeben. Der Benutzer
     * kann diese nun andern und die geanderten Daten werden in der Datenbank
     * abgespeichert.
     * 
     * @param request
     * @param response
    ...
    /**
     * Aus der Datenbank wird mit Hilfe der VeranstaltungsID die gewunschte
     * Veranstaltung geloscht. Falls es diese Veranstaltung nicht gibt, gibt
     * die Methode false zuruck
     * 
     * @param request
     * @param response
     * @return
     ...
     * Veranstaltung geschrieben.Falls es diese Veranstaltung nicht gibt, gibt
     * die Methode false zuruck
     * 
     * @param request
     * @param response
            ...
            throws IOException
    {
        ...
        try
        {
            ...
            Veranstaltung v = dbManager.leseVeranstaltung(vId); // TODO Kann das
            // weg?
     ...
     * Seine ID wird dann von der betreende Datenbank bezuglich der
     * Veranstaltung geloscht.Falls es diese Veranstaltung nicht gibt, oder er
     * noch nicht eingeschrieben ist,gibt die Methode false zuruck
     * 
     * @param request
     * @param response
     * @return
