...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  Registrieren(neuerNutzer: Benutzer): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  Anmelden(eMail-Adresse: String, Passwort : String): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  PasswortPrüfen(eMail-Adresse: String, Passwort : String): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  resetPasswort(eMail-Adresse: String) \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  gruppeErstellen(neueGruppe:Gruppe): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  gruppenLesen(Veranst: Veranstaltung, Mitglied: Benutzer=null): Gruppe[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  gruppeBearbeiten(Grp: Gruppe): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  gruppeVerlassen(Grp: Gruppe, Person:Benutzer): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  BenutzerstatusAendern(Person: Benutzer, Status: Enum): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  BenutzerLöschen(Person: Benutzer): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  ExportLerninhalt(Einstellungen: Exporteinstellungen): Datei \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  BenachrichtigungHinzufuegen(Benachr: ? extends Benachrichtigung): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  KarteikarteErzeugen(Veranst: Veranstaltung, Karte: ? extends Karteikarte): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  KarteikarteAendern(Karte: ? extends Karteikarte): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  KarteikarteLoeschen(Karte: ? extends Karteikarte): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  KarteikartenLesen(Veranst: Veranstaltung, Filter: KarteikartenFilter=null): ? extends Karteikarte[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  roterFadenlesen(Veranst: Veranstaltung): ? extends Karteikarte[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  roterFadenaendern(Veranst: Veranstaltung, roterFaden: ? extends Karteikarte[]): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  NotizLesen(Karte: Karteikarte, Nutzer: Benutzer): Notiz \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  NotizSpeichern(Karte: Karteikarte, Nutzer: Benutzer, Inhalt: Notiz): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  DiskussionsTitelLesen(Karte: Karteikarte): String[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  DiskussionLesen(Karte: Karteikarte, DiskussionsTitel: String): Diskussion \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  DiskussionErstellen(Diskuss: Diskussion, Karte: Karteikarte): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  kommentieren(Komment: Kommentar, Diskuss: Diskussion, Nutzer: Benutzer): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  bewerten(Komment: Kommentar, Nutzer: Benutzer): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  AktuellesLesen(anzahl: Int): Aktuelles[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  leseVeranstaltungen(): Veranstaltungen[] \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  pruefeVeranstaltungEingetragen(benutzer : Benutzer, veranstaltung : Veranstalung): Boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  leseVeranstaltung(name : String): Veranstaltung \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  pruefePasswortVeranstaltung(veranstaltung : Veranstaltung, passwort : String) : boolean \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  VeranstaltungEintragen(veranstaltung : Veranstaltung, benutzer : Benutzer) : String \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  VeranstaltungAnlegen(veranstaltung : Veranstaltung) \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  VeranstaltungBearbeiten(veranstaltung : Veranstaltung) \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  VeranstaltungLöschen(veranstaltung : Veranstaltung) \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  leseBenutzerdaten(name : String) : Benutzer \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  ändereBenutzerdaten(benutzer : Benutzer) \\ 
...
\begin{tabular}{|l|p{12cm}|}
	\hline
	Operation &  sucheBenutzer(muster : String) : Benutzer[] \\ 
